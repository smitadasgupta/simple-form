...
var _reactRadioGroup = __webpack_require__(9);
...
var FormInputApp = function (_React$Component) {
    _inherits(FormInputApp, _React$Component);

    function FormInputApp() {
        _classCallCheck(this, FormInputApp);

        return _possibleConstructorReturn(this, (FormInputApp.__proto__ || Object.getPrototypeOf(FormInputApp)).apply(this, arguments));
    }

    _createClass(FormInputApp, [{
        key: 'render',
        value: function render() {
            var heading = "Enter Details";
            return React.createElement(
                'div',
                null,
                React.createElement(Header, { heading: heading }),
...
var InputForm = function (_React$Component2) {
    ...
    _createClass(InputForm, [{
        ...
        key: 'handleRadioInputChange',
        value: function handleRadioInputChange(value) {
            this.setState({
                selectedValue: value
            });
        }
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('input', { type: 'text', name: 'fullname', onChange: this.handleInputChange.bind(this) }),
                    React.createElement(
                        'label',
                        null,
                        'Enter Age:'
                    ),
                    React.createElement('input', { type: 'number', name: 'age', onChange: this.handleInputChange.bind(this) }),
                    React.createElement('input', { id: 'checkFemale', type: 'checkbox', name: 'checkFemale', value: 'female', onClick: this.handleCheckbox.bind(this) }),
                    React.createElement(
                        'label',
                        { htmlFor: 'checkFemale' },
                        'Female'
                    ),
                    React.createElement('input', { type: 'checkbox', id: 'checkMale', name: 'checkMale', value: 'male', onClick: this.handleCheckbox.bind(this) }),
                    React.createElement(
                        'label',
                        { htmlFor: 'checkMale' },
                        'Male'
                    ...
                    React.createElement(
                        ...
                        { name: 'job', selectedValue: this.state.selectedValue, onChange: this.handleRadioInputChange.bind(this) },
                        React.createElement(_reactRadioGroup.Radio, { value: 'teacher' }),
                        'Teacher',
                        React.createElement(_reactRadioGroup.Radio, { value: 'doctor' }),
                        'Doctor',
                        React.createElement(_reactRadioGroup.Radio, { value: 'engineer' }),
                        'Engineer',
                        React.createElement(_reactRadioGroup.Radio, { value: 'other' }),
                        'Other'
                    ),
                    React.createElement(
                        'div',
                ...
                this.state.submitStatus && React.createElement(
                    'div',
                    null,
                    React.createElement(
                        'div',
...
ReactDOM.render(React.createElement(FormInputApp, null), document.getElementById('app'));
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(4),p=__webpack_require__(7);__webpack_require__(2);var r=__webpack_require__(1);
